...
#define BLE_UUID_CYCLING_POWER																	 0x1818			/**< Cycling power service UUID. */	
//#define BLE_UUID_BAROMETER_SERVICE															 0x1811			/**< Barometer service UUID. */	
...
// New defines
#define BLE_UUID_CYCLING_POWER_FEATURE_CHAR 										 0x2a65			/**< The CP Feature characteristic is used to report a list of features supported by the device. */
#define	BLE_UUID_CYCLING_POWER_MEASUREMENT_CHAR									 0x2a63			/**< The Cycling Power Measurement characteristic is a variable length structure containing a Flags field, 
																																								 an Instantaneous Power field and, based on the contents of the Flags field, may contain one or more */

// UUID Base and alias are defined in the service header file
//#define BLE_UUID_BAROMETER_LEVEL_CHAR														 0x1112																																						 
