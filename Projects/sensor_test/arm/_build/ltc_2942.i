 ...
 void ltc2942_init(void)
{
    ...
    twi_master_transfer(0xC8, i2c_data, 2, ((_Bool)1));
...
void ltc2942_test(void)
{
    ...
    twi_master_transfer(0xC8, i2c_data, 1, ((_Bool)1)); 
    
    
    twi_master_transfer(0xC9, i2c_data, 1, ((_Bool)1));
}
...
uint16_t ltc2942_read_voltage(void)
{
    ...
    twi_master_transfer(0xC8, i2c_data, 1, ((_Bool)0)); 
    
    
    twi_master_transfer(0xC9, i2c_data, 5, ((_Bool)0)); 
...
uint16_t ltc2942_read_temp(void)
{
    ...
    twi_master_transfer(0xC9, i2c_data, 2, ((_Bool)0)); 
