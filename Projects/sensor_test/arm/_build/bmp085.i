...
void bmp085_read_ac1(void)
{
    ...
    twi_master_transfer(0xEE, i2c_data, 1, ((_Bool)0)); 
		 
    
    twi_master_transfer(0xEF, i2c_data, 2, ((_Bool)1));
...
void bmp085_init(void)
{
    ...
    twi_master_transfer(0xEF, i2c_data, 22, ((_Bool)1));
...
double bmp085_read_temperature(void)
{
	...
	i2c_data[0] = 0xF4;				
	i2c_data[1] = 0x35; 
	twi_master_transfer(0xEE, i2c_data, 2, ((_Bool)1)); 
	
	
	i2c_data[0] = 0xF4;	
  twi_master_transfer(0xEE, i2c_data, 1, ((_Bool)1)); 

	twi_master_transfer(0xEF, i2c_data, 1, ((_Bool)1));
...
int16_t bmp085_read_pressure(void)
{
	...
	i2c_data[0] = 0xF4;				
	i2c_data[1] = 0x34;
	twi_master_transfer(0xEE, i2c_data, 2, ((_Bool)0)); 
	...
	twi_master_transfer(0xEF, i2c_data, 3, ((_Bool)1));
