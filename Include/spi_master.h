...
typedef struct
{
    ...
    uint32_t SPI_Pin_SS;    /**< Slave select MPU pin number. */
		//uint32_t SPI_Pin_SS_ADC1;		/**< Slave select ADC1 pin number. */
		//uint32_t SPI_Pin_SS_ADC2;		/**< Slave select ADC2 pin number. */
