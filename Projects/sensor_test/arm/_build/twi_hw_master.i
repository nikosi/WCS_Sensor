...
#line 1 "..\\..\\..\\Include\\powermeter_board.h"
...
#line 13 "..\\..\\..\\Include\\powermeter_board.h"
...
#line 35 "..\\..\\..\\Include\\powermeter_board.h"
...
#line 84 "..\\..\\..\\Include\\powermeter_board.h"
...
static _Bool twi_master_clear_bus(void)
{
    ...
    clk_pin_config =         ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[23u];

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[23u] =              ((0x00UL)  << (16UL))       | ((0x06UL)    << (8UL))         | ((0x03UL)   << (2UL))          | ((0UL) << (1UL))         | ((1UL)    << (0UL));
    ...
    data_pin_config =         ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[22u];

    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[22u] =               ((0x00UL)  << (16UL))       | ((0x06UL)    << (8UL))         | ((0x03UL)   << (2UL))          | ((0UL) << (1UL))         | ((1UL)    << (0UL));
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 22u); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 23u); } while(0);
    nrf_delay_us(4);

    if ((((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 22u) & 0x1UL) == 1) && (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 23u) & 0x1UL) == 1))
    {
        bus_clear = 1;
    }
    else
    {
        ...
        for (i=18; i--;)
        {
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << 23u); } while(0);
            nrf_delay_us(4);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << 23u); } while(0);
            nrf_delay_us(4);

            if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> 22u) & 0x1UL) == 1)
            {
                bus_clear = 1;
                break;
            }
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[23u] = clk_pin_config;
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[22u]  = data_pin_config;
...
_Bool twi_master_init(void)
{
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[23u] =             ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));
    ...
    ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[22u] =              ((0x00UL) << (16UL))       | ((0x06UL)     << (8UL))       | ((0x03UL)    << (2UL))        | ((0UL)  << (1UL))       | ((0UL)      << (0UL));
    ...
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_RXDREADY = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->EVENTS_TXDSENT  = 0;
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSCL         = 23u;
    ((NRF_TWI_Type *) 0x40004000UL)->PSELSDA         = 22u;
