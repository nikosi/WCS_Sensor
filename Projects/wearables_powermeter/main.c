...
#define DEVICE_NAME                          "WCS_Power"                      			/**< Name of device. Will be included in the advertising data. */
...
static void conn_params_init(void)
{
    ...
    //cp_init.start_on_notify_cccd_handle    = m_hrs.hrm_handles.cccd_handle;
		cp_init.start_on_notify_cccd_handle		 = m_cps.meas_handles.cccd_handle;
