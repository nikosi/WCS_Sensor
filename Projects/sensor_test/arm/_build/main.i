...
void simple_uart_putbuffer(const uint8_t * str, uint8_t length);
...
int main(void)
{
	  ...
	  nrf_gpio_cfg_output(28);
		...
		nrf_gpio_cfg_output(10u);
		nrf_gpio_cfg_output(12u);
		nrf_gpio_cfg_output(11u);

		
		nrf_gpio_cfg_output(4u);
		nrf_gpio_pin_set(4u);

		
		nrf_gpio_pin_set(10u);
		nrf_gpio_pin_set(12u);
		nrf_gpio_pin_set(11u);

		
		simple_uart_config(17, 19, 18, 20, 0);
