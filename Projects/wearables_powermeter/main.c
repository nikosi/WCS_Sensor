...
#define DEVICE_NAME                          "Telocate_Power"                      			/**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "Telocate GmbH"                					  /**< Manufacturer. Will be passed to Device Information Service. */
