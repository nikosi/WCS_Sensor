...
volatile _Bool spi_ads_done = 0;

 
static void spi_ads_init(spi_master_hw_instance_t spi_master_instance, spi_master_event_handler_t spi_master_event_handler, const _Bool lsb, uint8_t slave_select)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 40, (uint8_t*) "..\\ADS8320.c"); } while (0); } } while (0);
...
void spi_master_ads_event_handler(spi_master_evt_t spi_master_evt)
{
    switch (spi_master_evt.evt_type)
    {
        case SPI_MASTER_EVT_TRANSFER_COMPLETED:
            ...
            spi_ads_done = 1;
						nrf_gpio_pin_set(11u);
						nrf_gpio_pin_set(12u);
...
uint16_t ads8320_read(selector select)
{
    ...
    } else
    {
		...
		spi_ads_done = 0;
		spi_ads_init(SPI_MASTER_0, spi_master_ads_event_handler, 0, 11u);
